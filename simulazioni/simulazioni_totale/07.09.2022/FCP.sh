...
if test $# -lt 3
then
    echo "ERRORE : numero di parametri insufficiente $# - inserire almeno 3 parametri - usare $0 X G1 G2 ..."
    exit 1
else
...
case $1 in
    *[!0-9]*)
        ...
        ;;
    *)
        if test $1 -eq 0 -a $mod -eq 1
        then
            echo "ERRORE : parametro non corretto - il primo parametro deve essere != da 0 e deve essere dispari"
            exit 3
        else
